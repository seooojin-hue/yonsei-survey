...
const s0_q1 = [
  ...
  "보건의료정보의 콘텐츠와 기술의 국제 표준을 준수하고, AI가 활용 가능한 형태로 이를 적용·개발함으로써 국가 보건의료정보의 신뢰성과 상호운용성을 확보하고 정보교류 및 효율적 활용을 촉진하는 능력",
...
const SUBJECTS = [
  ["1-1", "의학용어(1)"], ["1-2", "의학용어(2)"],
  ["2-1", "보건의료정보관리학"], ["2-1", "병리학개론"],
  ["2-1", "공중보건학개론"], ["2-1", "보건의료통계"],
  ["2-2", "해부생리학"], ["2-2", "보건행정학"], ["2-2", "역학"],
  ["3-1", "질병및의료행위분류1"], ["3-1", "의료의질관리"],
  ["3-1", "보건의료데이터관리"], ["3-1", "의료정보기술"],
  ["3-2", "의무기록정보분석실무"], ["3-2", "암등록"],
  ["3-2", "건강보험이론및실무"], ["3-2", "질병및의료행위분류2"],
  ["4-1", "보건의료정보관리실무"], ["4-1", "건강정보보호"],
  ["4-1", "의무기록정보질향상실무"], ["4-1", "현장실습"],
  ["4-2", "보건의료조직관리"], ["4-2", "의료관계법규"], ["4-2", "의무기록전사"],
];
